...
<main class="container">
  <div class="form-modifica">
    ...
    <div style="margin-top: 30px;">
      <a href="form_modifica.php?id=<?= (int)$nota['id'] ?>" class="btn-primary">← Torna alla modifica</a>
      <a href="<?= $nota['autore'] === $utente ? 'profile.php' : 'home.php' ?>" class="btn-primary" style="margin-left: 10px;">← Torna alla home</a>
    </div>
